...
export const BETCRUZ_STYLES: ThemeClasses = {
  ...
  sports_sidebar: {
    ...
    "category-item-border": "border-[#EA3C00]/90 border-l-[#EA3C00]",
  ...
  betslip: {
    ...
    "slip-item-bg": "bg-[#ffffff]/80 border-[#EA3C0030]",
  ...
  game_options_modal: {
    ...
    "odds-button-selected-bg": "bg-gradient-to-r from-[#EA3C00] to-[#ea4201]",
